...
import SocialButton from '../../components/generic/SocialButton';
...
const Login = ({ facebookLogin, googleLogin }) => {
    ...
    const googleSignInConfigure = () => {
        GoogleSignin.configure({
            scopes: ['email'],
            androidClientId:
                '314309949116-8k0dqshr7qqjo3png0440bl99h31onqm.apps.googleusercontent.com',
            // offlineAccess: true,
        });
    };
        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.spaceAround}>
                <View style={styles.center}>
                    <Typography style={styles.center} variant="h1" color="#fff">
                        amare
                    </Typography>
                    <Typography style={styles.center} variant="h4" color="#fff">
                        Meet the one.
                    </Typography>
                </View>
                <View style={styles.center}>
